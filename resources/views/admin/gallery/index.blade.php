...
<div class="mx-auto max-w-7xl px-5 py-12">
    ...
    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <article class="overflow-hidden rounded-xl border border-mora-border bg-mora-surface">
            ...
            {{-- Image --}}
            <div class="aspect-[4/3] overflow-hidden bg-mora-card">

                <img src="{{ asset($item->image) }}" alt="{{ $item->title }}" class="h-full w-full object-cover transition duration-500 hover:scale-105" loading="lazy">
